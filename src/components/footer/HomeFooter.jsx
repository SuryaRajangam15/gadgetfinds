      ...
      <div className="container">
        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <span className="footer-link" onClick={() => navigate("/products")}>
              Products
            </span>
          ...
          <div>
            ...
            <span className="footer-link">Affiliate Disclosure</span>
        ...
        <div className="footer-bottom">
          <div>
            <p>© 2026 GadgetFinds.in · Curated by Surya</p>

            <p className="footer-affiliate">
              GadgetFinds participates in affiliate programs. Purchases through
              links may earn a commission at no extra cost to you.
            </p>
          </div>

          <span className="badge badge-blue">MADE WITH ❤️ IN INDIA</span>
        </div>
      </div>
    </footer>
  );
