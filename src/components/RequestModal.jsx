    ...
    >
      ...
      {step === 1 && (
        <div className="request-intro-modal">
          ...
          <div className="request-intro-top">
            <div className="request-intro-icon">📦</div>
          </div>

          <div className="request-intro-content">
            <h2>Request a Gadget ✨</h2>

            <p>Don’t find the gadget you're looking for?</p>

            <p className="request-subtext">
              Tell us what you want — we'll try to find it for you!
            </p>

            <button className="request-start-btn" onClick={() => setStep(2)}>
              Let’s Request 🚀
            </button>
          </div>
        </div>
      ...
      {step === 2 && (
        <div className="request-modal compact">
          ...
          <p>Tell us which gadget you want and your expected budget.</p>

          <form onSubmit={handleSubmit}>
            <div className="form-group">
              <label className="form-label">Gadget Name</label>
              ...
              <div className="budget-chips">
                {budgets.map((b) => (
                  <button
                    ...
                    key={b}
                    className={
                      budget === b ? "budget-chip active" : "budget-chip"
                    }
                    onClick={() => setBudget(b)}
                  >
                    {b}
